...
export default function Home() {
  return (
    <Bounded>
      ...
      <BioTemp  header="Experiences" organization="DreamsLab" date="2023 - Present" major="Web Developer Intern" description="web developing specializing in front-end development and interactive animation, utilize headless CMS solutions, like Handless, which allows for seamless API integration and content flexibility, and collaborate with team leads and UX/UI designers throughout the development process." />
