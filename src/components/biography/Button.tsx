...
const Button = ({linkField, label, showIcon = true, className}:ButtonProps) => {
  return (
    <button className={clsx("group relative flex text-slate-800 w-full items-center justify-center overflow-hidden rounded-md border-2 border-slate-900 bg-slate-50 px-4 py-2 font-bold transition-transform ease-out hover:scale-105", className)}>
        <Link href={linkField}>
